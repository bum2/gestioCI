...
01: COOPERATIVAS [models.py/coop]

02: IVAS [models.py/vats]

03: PAGOS_FACTURAS [models.py/Purchases_invoices]
04: COBROS_FACTURAS [models.py/Sales_invoices]

05: CIERRE_PERIODO [models.py/period_close]

06: PAGOS_ENTIDADES [models.py/payment_entities]
07: COBROS_ENTIDADES [models.py/refund_entities]

08: EMAIL_NOTIFICATION [models.py/email_notification]
	081: EMAIL_NOTIFICATION [models.py/email]

09: CSVIMPORT [models.py/csvimport]
'''
